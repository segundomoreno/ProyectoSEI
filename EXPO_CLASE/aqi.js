...
//Temperatura
if(data.temp<16)
	alert("Hace mucho frío, se recomienda encender la calefacción ahora");
if(data.temp>16 && data.temp<19)
	alert("La temperatura es templada, se recomienda encender la calefacción.");
if(data.temp>19 && data.temp<24)
	alert("La temperatura es buena, mantenga la calefacción a ese nivel.");
if(data.temp>24)
	alert("La temperatura es elevada, reduzca la potencia de la calefacción.");

//Humedad
if(data.hum<20)
	alert("Demasiada poca humedad, encienda un humidificador o ventile la sala.");
if(data.hum>20 && data.hum<40)
	alert("La humedad es algo baja, se recomienda ventilar o encender un humidificador");
if(data.hum>40 && data.hum<65)
	alert("Buen nivel de humedad relativa.");
if(data.hum>65 && data.hum < 85)
	alert("Humedad relativa algo elevada, se recomienda encender un deshumidificador.");
if(data.hum>85)
	alert("Humedad muy elevada,encienda un deshumidificador.");
